...
# RNN_folder = '0.0111542_CDDM;tanh;N=100;lmbdo=0.3;lmbdr=0.5;lr=0.005;maxiter=1500'

taskname = RNN_folder.split("_")[1].split(";")[0]
data_save_path = os.path.join(data_save_path, "CDDMtanh")
disp = False

RNN_folder_full_path = os.path.join(projects_folder, "rnn_coach", "data", "trained_RNNs", "CDDMtanh", RNN_folder)
