...
W_inp[:2, :2] = np.eye(2)
W_inp[6:10, 2:6] = np.eye(4) #auxiliary nodes serve as inputs
# allow input to the auxiliary nodes
...
rec_connectivity_mask[6, :] = 0
rec_connectivity_mask[7, :] = 0
rec_connectivity_mask[8, :] = 0
rec_connectivity_mask[9, :] = 0
rec_connectivity_mask[:, 6:10] = 0
rec_connectivity_mask[6:10, 6:10] = np.eye(4)
rec_connectivity_mask[2:6, 6:10] = np.eye(4)
